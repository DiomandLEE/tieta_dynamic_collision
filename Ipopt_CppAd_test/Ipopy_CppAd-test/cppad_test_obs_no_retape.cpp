...
class FG_eval
{
	public:
	    ...
	    void operator()(ADvector& fg, const ADvector& x)
	    {
            ...
            if ((CppAD::pow(x1 - 2, 2) + CppAD::pow(y1 - 0, 2)) < 2.25)
            {
                fg[0] += 10 * CppAD::pow(CppAD::sqrt(CppAD::pow(x1 - 2, 2) + CppAD::pow(y1 - 0, 2)) - 1.5, 2);
            }
            if ((CppAD::pow(x2 - 2, 2) + CppAD::pow(y2 - 0, 2)) < 2.25)
            {
                fg[0] += 10 * CppAD::pow(CppAD::sqrt(CppAD::pow(x2 - 2, 2) + CppAD::pow(y2 - 0, 2)) - 1.5, 2);
            }
            if ((CppAD::pow(x3 - 2, 2) + CppAD::pow(y3 - 0, 2)) < 2.25)
            {
                fg[0] += 10 * CppAD::pow(CppAD::sqrt(CppAD::pow(x3 - 2, 2) + CppAD::pow(y3 - 0, 2)) - 1.5, 2);
            }
            if ((CppAD::pow(x4 - 2, 2) + CppAD::pow(y4 - 0, 2)) < 2.25)
            {
                fg[0] += 10 * CppAD::pow(CppAD::sqrt(CppAD::pow(x4 - 2, 2) + CppAD::pow(y4 - 0, 2)) - 1.5, 2);
            }
            if ((CppAD::pow(x5 - 2, 2) + CppAD::pow(y5 - 0, 2)) < 2.25)
            {
                fg[0] += 10 * CppAD::pow(CppAD::sqrt(CppAD::pow(x5 - 2, 2) + CppAD::pow(y5 - 0, 2)) - 1.5, 2);
            }
