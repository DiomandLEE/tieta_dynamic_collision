...
int main(int argc, char** argv)
{
    ...
    pnh.param<std::string>("/DoorTrajPub/dynamic_collision_mpc/csvfile_path", _csv_file, "/home/diamondlee/VKConTieta_ws/src/tieta_mpc_sim_demo/tieta_track_traj/pick/retimed_pickTraj_15_36_51.csv");
    ...
    ros::Publisher anglesList_pub = pnh.advertise<DoorTrajPub::AnglesList>("anglesList_topic", 1);
